...
int
check_precision(float xmin, float xmax, const char* name, v4sf (*fn)(v4sf),
...
int
check_precision2(float xmin, float xmax, const char* name, v4sf (*fn)(v4sf, v4sf),
...
{
    return atan2_f(x, x + 0.1f);
}

float
stupid_cephes_atan2f(float x)
{
    return cephes_atan2f(x, x + 0.1f);
}
...
DECL_VECTOR_FN_BENCH(_mm_rsqrt_ss);
DECL_SCALAR_FN_BENCH(rsqrt_f);

DECL_SCALAR_FN_BENCH(tanf);
DECL_SCALAR_FN_BENCH(cephes_tanf);
DECL_VECTOR_FN_BENCH(tan_ps);
DECL_SCALAR_FN_BENCH(tan_f);

DECL_SCALAR_FN_BENCH(cotf);
DECL_SCALAR_FN_BENCH(cephes_cotf);
DECL_VECTOR_FN_BENCH(cot_ps);
DECL_SCALAR_FN_BENCH(cot_f);

DECL_SCALAR_FN_BENCH(acosf);

DECL_SCALAR_FN_BENCH(atanf);
DECL_SCALAR_FN_BENCH(cephes_atanf);
DECL_VECTOR_FN_BENCH(atan_ps);
DECL_SCALAR_FN_BENCH(atan_f);

DECL_SCALAR_FN_BENCH(stupid_atan2f);
DECL_SCALAR_FN_BENCH(stupid_cephes_atan2f);
DECL_VECTOR_FN_BENCH(stupid_atan2_ps);
DECL_SCALAR_FN_BENCH(stupid_atan2_f);
//TODO atan2_f
...
main()
{
    ...
    run_bench("sqrt_ps", bench__mm_sqrt_ss);
    run_bench("sqrt_f", bench_sqrt_f);

    printf("\n");
    run_bench("rsqrtf", bench_rsqrtf);
    run_bench("rsqrt_ps", bench__mm_rsqrt_ss);
    run_bench("rsqrt_f", bench_rsqrt_f);

    printf("\n");
    run_bench("tanf", bench_tanf);
    run_bench("cephes_tanf", bench_cephes_tanf);
    run_bench("tan_ps", bench_tan_ps);
    run_bench("tan_f", bench_tan_f);

    printf("\n");
    run_bench("atanf", bench_atanf);
    run_bench("cephes_tanf", bench_cephes_atanf);
    run_bench("atan_ps", bench_atan_ps);
    run_bench("atan_f", bench_atan_f);

    printf("\n");
    run_bench("atan2f", bench_stupid_atan2f);
    run_bench("cephes_atan2", bench_stupid_cephes_atan2f);
    run_bench("atan2_ps", bench_stupid_atan2_ps);
    run_bench("atan2_f", bench_stupid_atan2_f);

    printf("\n");
    run_bench("cotf", bench_cotf);
    run_bench("cephes_cot", bench_cephes_cotf);
    run_bench("cot_ps", bench_cot_ps);
    run_bench("cot_f", bench_cot_f);
